...
SELECT cours.titre AS titre_du_cours, categories.nom AS nom_de_la_categorie
FROM cours
LEFT JOIN categories ON cours.id_categorie = categories.id_categorie;

SELECT titre nom FROM cours 
LEFT JOIN categories ON cours.id_categorie = 